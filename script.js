...
const translations = {
    ms: {
        ...
        "heroBadge": "🧠 Pembelajaran mesra dan lucu",
        "heroSubtitle": "Perasaan besar? Tak mengapa. Kita belajar dengan gelak kecil, langkah kecil, dan high-five.",
        "heroTip": "Tip: Mahu rehat? Tarik nafas perlahan tiga kali dan buat tarian goyang kecil. 🐥",
        "mascotBubble": "Hai! Saya Buddy. Saya suka jenaka dan belajar!",
        "comfortTitle1": "Pilih kelajuan kamu",
        "comfortText1": "Sentuh, berhenti, dan ulang sebanyak yang kamu mahu.",
        "comfortTitle2": "Warna yang tenang",
        "comfortText2": "Bentuk lembut dan langkah jelas bantu kamu rasa selamat.",
        "comfortTitle3": "Saat lucu",
        "comfortText3": "Tip kelakar buat pembelajaran ringan dan gembira.",
        "chooseAdventure": "Pilih pengembaraan kamu",
        "chooseMe": "Pilih saya!",
    ...
    zh: {
        ...
        "heroBadge": "🧠 友好又有趣的学习",
        "heroSubtitle": "情绪很大？没关系。我们用小步、笑声和击掌一起学习。",
        "heroTip": "小贴士：想休息？慢慢深呼吸三次，再做个小小摇摆舞。🐥",
        "mascotBubble": "嗨！我是 Buddy。我喜欢笑话和学习！",
        "comfortTitle1": "选择你的速度",
        "comfortText1": "可以点击、暂停、重复，想多久都可以。",
        "comfortTitle2": "安静的颜色",
        "comfortText2": "柔和形状与清晰步骤让你更安心。",
        "comfortTitle3": "有趣时刻",
        "comfortText3": "小小笑点让学习更轻松开心。",
